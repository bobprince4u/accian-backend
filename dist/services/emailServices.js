...
const sendAdminNotification = async (data) => {
    try {
        ...
        const info = await transporter.sendMail(mailOptions);
        await logEmail("admin_notification", process.env.ADMIN_EMAIL, mailOptions.subject, "sent");
        ...
        await logEmail("admin_notification", process.env.ADMIN_EMAIL, "Admin Notification", "failed", errorMessage);
